...
3. สำหรับแต่ละรายการ WMS ที่ยังรอดำเนินการ:
   - **"ไม่ได้หยิบ"** — ไม่มีการหยิบหรือตัดสต๊อก จึงไม่ปรับยอดสินค้า
   - กด **"คืนสต๊อก"** — หากหยิบ/ตัดสินค้าแล้วและนำสินค้ากลับได้
   - กด **"ของเสีย"** — หากหยิบ/ตัดสินค้าแล้วแต่เสียหายหรือคืนไม่ได้

> หาก Picker แจ้งสินค้าหมดก่อนหยิบและไม่มี movement ระบบจะบันทึกเป็น “ไม่ได้หยิบ” อัตโนมัติ แต่แจ้งเตือนสินค้าหมดยังคงอยู่ให้คลังตรวจว่าหมดจริงหรือเพียงหาไม่พบ

### ความหมายของสถานะสต๊อก
| สถานะ | ความหมาย |
|--------|----------|
| รอดำเนินการ (เหลือง) | ยังไม่มีการจัดการ |
| ไม่ได้หยิบ (เทา) | ใบงานไม่เคยหยิบสินค้าและไม่กระทบยอดสต๊อก |
...
### หมายเหตุเรื่อง Role
- `sales-tr`, `sales-pump` — พนักงานขายผู้เปิดบิลของบริษัท TR หรือ PUMP (ไม่ใช่ผู้อนุมัติ)
