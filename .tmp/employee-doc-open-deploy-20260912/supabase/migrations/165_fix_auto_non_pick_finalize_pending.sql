-- 165: Finalize pending system_complete rows for non-pick work orders
-- If a work order already has system_complete rows stuck in pending,
-- promote them to correct so stock deduction can happen.
