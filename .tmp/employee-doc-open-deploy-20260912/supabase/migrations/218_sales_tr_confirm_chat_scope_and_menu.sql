-- sales-tr: นับ unread แชทบิลเฉพาะคิว Confirm (PUMP + สถานะ pipeline) ให้สอดคล้อง production และข้อความยังไม่อ่าน
-- เปิดเมนู orders-confirm สำหรับ sales-tr ถ้ายังไม่มีแถวใน st_user_menus
...
VALUES ('sales-tr', 'orders-confirm', 'Confirm', true)
