-- 216: soft-deprecate status "ย้ายจากใบงาน"
-- - New writes should use "ใบสั่งงาน" directly
-- - Keep frontend/query compatibility for both statuses temporarily
-- - Migrate historical rows from "ย้ายจากใบงาน" -> "ใบสั่งงาน"
...
'ย้ายบิลกลับคิว Plan→ใบสั่งงาน: เขียนสถานะใบสั่งงานโดยตรง (soft-deprecate สถานะย้ายจากใบงาน)';

UPDATE or_orders
SET
  status = 'ใบสั่งงาน',
  updated_at = NOW()
WHERE status = 'ย้ายจากใบงาน';
