-- 254: Harden data reset RPC auth path for PostgREST callers
-- - Avoid cardinality violations in scalar subqueries (SQLSTATE 21000)
-- - Disable row_security inside SECURITY DEFINER reset workflow
