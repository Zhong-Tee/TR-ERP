  ...
  if (activeView === 'menu') {
    return (
      <div className="min-h-screen w-full bg-gray-50 text-gray-900 flex flex-col overflow-hidden rounded-none">
        <header className="p-3 flex justify-between items-center bg-emerald-600 text-white shadow-md sticky top-0 z-20">
          <div className="flex flex-col min-w-0">
            <span className="text-xs text-emerald-100/80 font-bold uppercase truncate">Auditor</span>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          <div className="text-center py-4">
            <div className="text-2xl font-black text-gray-800">Auditor</div>
      ...
      <div className="min-h-screen w-full bg-gray-50 text-gray-900 flex flex-col overflow-hidden rounded-none">
        <header className="p-3 flex justify-between items-center bg-emerald-600 text-white shadow-md sticky top-0 z-20">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-xs text-emerald-100/80 font-bold uppercase truncate">{activeLabel}</span>
              <span className="text-sm font-black leading-tight truncate">
                {user?.username || user?.email || '---'}
              </span>
            </div>
