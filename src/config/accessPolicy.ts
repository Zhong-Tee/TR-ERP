...
export const DESKTOP_MENU_PATH_ORDER: { key: string; path: string; roles: UserRole[] }[] = [
  ...
  { key: 'machinery', path: '/machinery', roles: ['superadmin', 'admin', 'production', 'store'] },
...
const PATH_MENU_PREFIX_MAP: Array<{ prefix: string; key: string }> = [
  ...
  { prefix: '/hr/work-score', key: 'hr-work-score' },
  ...
  { prefix: '/hr/announcements', key: 'hr-announcements' },
...
export const PARENT_SUB_PAGES: Record<string, { path: string; key: string }[]> = {
  ...
  '/hr': [
    ...
    { path: '/hr/work-score', key: 'hr-work-score' },
    { path: '/hr/work-calendar', key: 'hr-work-calendar' },
    { path: '/hr/announcements', key: 'hr-announcements' },
