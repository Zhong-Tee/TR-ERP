...
export interface OperationRequirement { id?:string; department_name:string; process_name:string; required_workers:number; minimum_proficiency:number; required_supervisors:number }
