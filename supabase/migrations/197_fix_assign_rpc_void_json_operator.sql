-- 197: Fix rpc_assign_wms_for_work_order_v2 calling void function with ->>
-- fn_wms_try_auto_consume_non_pick RETURNS void (see 186), so using ->> causes:
--   operator does not exist: void ->> unknown
...
BEGIN
  ...
  -- 3) non-pick: ฟังก์ชันเดิมเป็น void → ใช้ PERFORM แล้วคำนวณจำนวนเอง
