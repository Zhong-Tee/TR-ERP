-- =====================================================================
-- Migration 117: เพิ่มช่องทาง OFFICE + อัปเดต RPC get_sidebar_counts
-- =====================================================================

-- 1. เพิ่ม channel OFFICE
INSERT INTO channels (channel_code, channel_name)
VALUES ('OFFICE', 'Office')
ON CONFLICT (channel_code) DO NOTHING;

-- 2. อัปเดต RPC get_sidebar_counts — ซ่อน OFFICE จาก role ที่ไม่ใช่ superadmin/admin
...
BEGIN
  ...
  --    OFFICE: เฉพาะ superadmin/admin เห็น
  IF v_is_owner THEN
