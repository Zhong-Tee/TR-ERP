-- 152: Support order_point_days in initial stock import RPC
-- Keep backward compatibility for old files (missing order_point_days -> NULL)
  ...
  LOOP
    ...
    BEGIN
      INSERT INTO pr_products (
        ...
        seller_name, product_name_cn, order_point, order_point_days,
